<?php
	...
	// Creates a taxonomy
	function cstmstff_create_taxonomy_tag( $obj ) {
		...
		$args = array(
			'labels'            => $labels,
			'descritpion'      	=> 'This is a taxonomy. Kinda like a tag.',
			'public'            => true, // Set to false for private taxonomy
			'hierarchical'      => false, // Set to false for tags
			'show_ui'           => true,
		...
		register_taxonomy( $obj['prefix'] . '-taxonomy-tag', $obj['prefix'] . '-post-type', $args );
	}

	// Init the taxonomy
	add_action( 'init', function() use ( $obj ) { cstmstff_create_taxonomy_tag( $obj ); }, 10 );
