<?php
	...
	// Creates a taxonomy
	function cstmstff_create_taxonomy_public( $obj ) {
		// Taxonomy name variables
		$singular = 'Public Category';
		$singular_lower = strtolower( $singular );
		$plural = 'Public Categories';
		...
		register_taxonomy( $obj['prefix'] . '-taxonomy-public', $obj['prefix'] . '-post-type', $args );
	}

	// Init the taxonomy
	add_action( 'init', function() use ( $obj ) { cstmstff_create_taxonomy_public( $obj ); }, 10 );
