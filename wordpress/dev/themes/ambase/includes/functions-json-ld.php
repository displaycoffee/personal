<?php
	...
	*/
    ...
    function ambase_blog_json( $post ) {
		...
		$categories = ambase_term_list( $post->ID, 'category', ', ' );
		$categories = $categories ? $categories . ', ' : '';

		// Get category and tags for keywords
		$keywords = $categories . ambase_term_list( $post->ID, 'post_tag', ', ' );
		...
		// Text / description
		$json_ld .= '"text": "' . esc_html( ambase_excerpt( false ) ) . '"';
