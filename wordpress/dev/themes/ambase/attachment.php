					...
					<div id="entry-<?php esc_attr( the_ID() ); ?>" class="entry attachment">
						<?php 
							...
							if ( $att_parent_title ) {
								...
								$att_header = '<div class="entry-published"><p><strong>' . __( 'Published in: ', 'ambase' ) . '</strong>';
						...
						<div class="entry-content">
							<?php 
								...
								if ( wp_attachment_is_image( $post->ID ) ) {
									...
									if ( $att_caption ) {
										$att_content .= '<figcaption class="wp-caption-text"><strong>' . __( 'Details', 'ambase' ) . ':</strong> ' . $att_caption . '</figcaption>';										
									}
									...
									// Check if the attachment has a caption and continue attachment content block
									if ( $att_caption ) {
										$att_content .= '<p class="wp-caption-text"><strong>' . __( 'Details', 'ambase' ) . ':</strong> ' . $att_caption . '</p>';
									}
