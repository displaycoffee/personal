...
<div class="entry-author">
	<?php
		...
		if ( !is_author() ) { 	
			echo '<h3>' . __( 'About', 'ambase' ) . ' ' . $author_name . '</h3>';
		}
	?>
	<?php 
	...
	<?php 
		...
		$author_social_links = $author_website ? ambase_create_link( 'website', $author_website, 'Website' ) : '';
		$author_social_links .= $author_facebook ? ambase_create_link( 'facebook', $author_facebook, 'Facebook' ) : '';
		$author_social_links .= $author_gplus ? ambase_create_link( 'gplus', $author_gplus, 'Google+' ) : '';
		$author_social_links .= $author_linkedin ? ambase_create_link( 'linkedin', $author_linkedin, 'LinkedIn' ) : '';
		$author_social_links .= $author_twitter ? ambase_create_link( 'twitter', $author_twitter, 'Twitter' ) : '';			
		$author_social_links .= $author_instagram ? ambase_create_link( 'instagram', $author_instagram, 'Instagram' ) : '';
		$author_social_links .= $author_youtube ? ambase_create_link( 'youtube', $author_youtube, 'YouTube' ) : '';
		$author_social_links .= $author_pinterest ? ambase_create_link( 'pinterest', $author_pinterest, 'Pinterest' ) : '';
		$author_social_links .= $author_tumblr ? ambase_create_link( 'goodreads', $author_pinterest, 'Goodreads' ) : '';
		$author_social_links .= $author_goodreads ? ambase_create_link( 'tumblr', $author_pinterest, 'Tumblr' ) : '';
