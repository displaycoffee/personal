...
<div class="sharing-buttons menu-social-container">
    <?php _e( '<strong>Share On:</strong>', 'ambase' ); ?>
    <ul class="menu">
		<li>			    
		...
		<li>			   
		    <a href="//twitter.com/share?url=<?php echo get_permalink(); ?>&amp;text=<?php echo get_the_title(); ?>&amp;hashtags=theambase" target="_blank">Twitter</a>
		</li>			
		<li>
		...
		<li>
		    <a href="mailto:?Subject=<?php echo get_the_title(); ?>&amp;Body=Shared%20from%20theambase.com%20 <?php echo get_permalink(); ?>">Email</a>	 
		</li>			
    </ul>
</div>